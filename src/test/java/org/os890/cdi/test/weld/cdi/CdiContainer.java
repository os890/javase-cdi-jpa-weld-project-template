 ...
 * under the License.
 */
package org.os890.cdi.test.weld.cdi;
 ...
 * Container. It allows starting and stopping the container and to run
...
public interface CdiContainer {
     ...
     * run all CDI Contexts! Depending on the underlying CDI container you
    ...
    void bootFor(Class... beanClasses);
